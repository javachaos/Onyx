...
public class Display {
     ...
     * @param dcPin
     *            Data/Command pin
     * @see Display#Display(int, int, GpioController, SpiDevice, Pin, Pin) Using
     *      this constructor with null Pin
     * @see GpioFactory#getInstance() GpioController instance factory
     * @see com.pi4j.io.spi.SpiFactory#getInstance(SpiChannel) SpiDevice factory
     */
     ...
     * @param address
     *            Display address
     * @see Display#Display(int, int, GpioController, I2CBus, int, Pin) Using
     *      this constructor with null Pin
     * @see GpioFactory#getInstance() GpioController instance factory
     * @see com.pi4j.io.i2c.I2CFactory#getInstance(int) I2C bus factory
     */
