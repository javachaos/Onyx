...
public class Pid {
     ...
     * 
     * @param controllerPeriod
     *            the time frame between samples.
     * 
     *            If the sampleTime is greater than the controller period the
     *            sample rate is set to Default of 1000ns.
     */
