...
/**
 * Listener for Evdev events. Copyright (C) 2009 Giacomo Ferrari
 *
...
public interface InputListener {
    /**
     * This method is called by a EventDevice when an event is reported by the
     * event device under its watch.
     *
     * @param e
     *            The event details.
     */
